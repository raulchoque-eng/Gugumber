...
//        strategyHashMap.put(START_DATE, () -> validateDetailsOfNewEvent(evenDetailMap.get(START_DATE), event.getStartDate()));
//        strategyHashMap.put(END_DATE, () -> validateDetailsOfNewEvent(evenDetailMap.get(END_DATE), event.getEndDate()));
    ...
    public void validateDetailsOfNewEvent(String uiDeatail, String eventDetail ) {

        assertEquals(uiDeatail, eventDetail);
    }
}
